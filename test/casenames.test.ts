...
describe('the name itself', () => {
  it('is the type and the person, the way the practice writes it', () => {
    expect(caseName('Partner Resident Visa', 'Dinh Dai Phu PHAN'))
      .toBe('Partner Resident Visa — Dinh Dai Phu PHAN');
  });
  ...
  it('is never empty, whatever it is given', () => {
    ...
    expect(caseName('', 'Dinh Dai Phu PHAN')).toBe('Dinh Dai Phu PHAN');
  });
