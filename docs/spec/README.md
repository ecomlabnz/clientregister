...
| [`invariants.md`](invariants.md) | The 103 things the database refuses to do, in its own words, and the 10 uniqueness rules | Extracted from the built schema, and held against it by a test |
