...
| [`invariants.md`](invariants.md) | The 192 things the database refuses to do, in its own words, and the 13 uniqueness rules | `npm run spec`, from the built schema |
| [`data-model.md`](data-model.md) | 59 tables, every column | `npm run spec`, from the built schema |
...
**1. [`mistakes.md`](mistakes.md).** 45 faults, each with the rule that
...
**2. [`invariants.md`](invariants.md).** The 192 rules the database enforces. This is
