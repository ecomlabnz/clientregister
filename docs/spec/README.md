...
| [`invariants.md`](invariants.md) | The 232 things the database refuses to do, in its own words, and the 13 uniqueness rules | `npm run spec`, from the built schema |
...
**2. [`invariants.md`](invariants.md).** The 232 rules the database enforces. This is
