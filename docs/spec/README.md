...
| [`routes.md`](routes.md) | 227 routes and the permission each runs behind, the public surface listed first | `npm run spec`, from the built router |
| [`settings.md`](settings.md) | 91 settings — everything an administrator can change without a deployment | `npm run spec`, from the modules |
